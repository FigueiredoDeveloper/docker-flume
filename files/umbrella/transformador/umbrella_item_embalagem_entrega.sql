drop table if exists dw_umbrella.umbrella_item_embalagem_entrega_tmp;

create table dw_umbrella.umbrella_item_embalagem_entrega_tmp stored as parquet as
select    ID_PEDIDO
        , ENTREGA
        , SKU_FUSION
        , QTDE_PEDIDA
...
drop table if exists dw_umbrella.umbrella_item_embalagem_entrega;

alter table dw_umbrella.umbrella_item_embalagem_entrega_tmp rename to dw_umbrella.umbrella_item_embalagem_entrega;