            ...
            create table if not exists datalake_umbrella.umbrella_wf_referencia_doc_ent (sref_id_refdoc string
, sref_id_cia string
...
, sref_id_loja string
, key_wf_referencia_doc_ent string
, data_inclusao timestamp
, data_carga timestamp) partitioned by (data_inclusao_p string)
            stored as parquet;

            create table if not exists tmp.umbrella_wf_referencia_doc_ent (sref_id_refdoc string
, sref_id_cia string
, sref_id_fonte_ult string
, sref_id_ponto_ult string
, sref_dt_rastr_ult timestamp
