            ...
            create table if not exists datalake_umbrella.umbrella_wf_referencia_documental (sref_id_refdoc string
, sref_id_cia string
...
, data_carga timestamp) partitioned by (data_inclusao_p string)
            ...
            create table if not exists tmp.umbrella_wf_referencia_documental (sref_id_refdoc string
, sref_id_cia string
, sref_id_fonte_ult string
, sref_id_ponto_ult string
, sref_dt_rastr_ult timestamp
