...
create table if not exists tmp.umbrella_nf(
    key_nf                         string
...
create table if not exists  datalake_umbrella.umbrella_nf(
      key_nf                         string
    , data_registro 				 timestamp
	, filial                      	 int   
	, nf                          	 bigint  
...
create table if not exists tmp.tmp_umbrella_nf like tmp.umbrella_nf;
